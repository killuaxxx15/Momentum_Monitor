...
relative_ranking1 = df1['Relative Ranking.1']
sorted_relative_ranking1 = relative_ranking1.sort_values()
lowest_10 = sorted_relative_ranking1.head(10).values
highest_10 = sorted_relative_ranking1.tail(10).values
df1['Relative Ranking'] = relative_ranking1.apply(color_circle_1, args=(lowest_10, highest_10))
