...
excel_file = 'Sentiment_Data_21_06_2024.xlsx'
sheet_name = 'Sheet1'
...
st.image('fig1_21_06_2024.png', caption='Figure 1', use_column_width=True)
...
rolling_corr_sp500 = sp500_returns.rolling(window=60).corr(treasury_yield_returns)
rolling_corr_russell2000 = russell2000_returns.rolling(window=60).corr(treasury_yield_returns)
