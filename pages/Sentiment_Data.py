...
excel_file = 'Sentiment_Data_30_08_2024.xlsx'
sheet_name = 'Sheet1'
...
st.image('fig1_30_08_2024.png', caption='Figure 1', use_column_width=True)

st.header('Put/Call & Vix')
st.image('fig2_30_08_2024.png', caption='Figure 2', use_column_width=True)
