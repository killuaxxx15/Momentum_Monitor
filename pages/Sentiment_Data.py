...
st.markdown('#### Updated: 09/08/2024')

# Define Excel file and sheet name variables
excel_file = 'Sentiment_Data_09_08_2024.xlsx'
sheet_name = 'Sheet1'
...
st.image('fig1_09_08_2024.png', caption='Figure 1', use_column_width=True)

st.header('Put/Call & Vix')
st.image('fig2_09_08_2024.png', caption='Figure 2', use_column_width=True)
