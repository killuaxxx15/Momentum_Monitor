...
st.markdown('#### Updated: 10/10/2024')

# Define Excel file and sheet name variables
excel_file = 'Global_macro_rankings_final_10_10_2024.xlsx'
...
# TABLE 1
df1 = load_excel_data(excel_file, sheet_name, 'E:H', 2, 9)
...
# TABLE 2
df2 = load_excel_data(excel_file, sheet_name, 'E:K', 16, 14)
...
# TABLE 3
df3 = load_excel_data(excel_file, sheet_name, 'E:P', 34, 10)
...
# TABLE 4
df4 = load_excel_data(excel_file, sheet_name, 'E:I', 47, 9)
...
df5 = pd.read_excel(excel_file,
                   ...
                   header=42,
                   nrows=10)
df5 = load_excel_data(excel_file, sheet_name, 'K:M', 47, 10)
...
# TABLE 6
df6 = load_excel_data(excel_file, sheet_name, 'E:F', 59, 7)
