...
df2.columns = ['ETF', 'Above 30 D ', 'Above 60 D', 'Above 200D', 'Relative Ranking', 'Relative Ranking.1']
...
df3.columns = ['ETF', 'Relative Ranking', 'U/D', 'Breadth', 'Closeness to 52 week', '3 month return', 'U/D.1', 'Breadth.1', 'Closeness to 52 week.1', '3 month return.1', 'Median']
...
df5.columns = ['ETF', 'Upgrades 1 month', 'Downgrades 1 month']
...
df6.columns = ['ETF', 'Long Term Forecasts']
